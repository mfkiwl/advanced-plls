...
%   Email: rdlfresearch@gmail.com
    ...
    methods(Test)
        ...
        function testBoundaryProfileMismatch(testCase)
            % Set boundaries count different from the length of expected_doppler_profile.
            config = testCase.default_general_config;
            config.initial_states_distributions_boundaries = {[-pi, pi], [-5, 5]}; % Only 2 boundaries but expected_doppler_profile length is 3.
