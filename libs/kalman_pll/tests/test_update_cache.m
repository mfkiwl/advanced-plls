classdef test_update_cache < matlab.unittest.TestCase
    ...
    %
    % Syntax:
    %   results = runtests('test_update_cache')
    %
    % Description:
    %   Unit tests for the update_cache function. This test suite verifies:
    ...
    methods(TestClassSetup)
        function add_parent_path(test_case)
            % Add the parent directory so that update_cache.m 
    ...
    methods(Test)
        function test_valid_config_csm(test_case)
            ...
            updated_pll_config = update_cache(config, ...
        ...
        function test_missing_required_field(test_case)
            ...
            test_case.verifyError(@() update_cache(config, ...
                test_case.default_cache_file, test_case.default_sampling_interval, ...
                test_case.minimal_pll_config, is_cache_used), ...
        ...
        function test_invalid_config_type(test_case)
            ...
            test_case.verifyError(@() update_cache(invalid_config, ...
                test_case.default_cache_file, test_case.default_sampling_interval, ...
                test_case.minimal_pll_config, is_cache_used), ...
