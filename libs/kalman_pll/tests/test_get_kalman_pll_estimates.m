classdef test_get_kalman_pll_estimates < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function testValidStatesAdaptiveSelfAdaptive(testCase)
            % Create a valid adaptive config for state covariance using the "self_adaptive" algorithm.
            adaptive_config = testCase.default_adaptive_config;
            adaptive_config.states_cov_adapt_algorithm = 'self_adaptive';
            adaptive_config.states_cov_adapt_algorithm_params = struct( ...
                'init_meas_cov', 1e-3, ...
                'init_states_cov', 1e-2, ...
                'sigma_threshold', 0.1);
