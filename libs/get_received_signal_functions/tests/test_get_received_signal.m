    ...
    methods(Test)
        function testValidNoneModel(testCase)
            ...
            [rx_sig, los_phase, psi, diffractive_phase, refractive_phase] = get_received_signal(...
                testCase.C_over_N0_dBHz, 'none', testCase.doppler_profile, testCase.seed, ...
        ...
        function testValidCSMModel(testCase)
            ...
            [rx_sig, los_phase, psi, diffractive_phase, refractive_phase] = get_received_signal(...
                testCase.C_over_N0_dBHz, 'CSM', testCase.doppler_profile, testCase.seed, ...
        ...
        function testValidTPPSMModel(testCase)
            ...
            [rx_sig, los_phase, psi, diffractive_phase, refractive_phase] = get_received_signal(...
                testCase.C_over_N0_dBHz, 'TPPSM', testCase.doppler_profile, testCase.seed, ...
