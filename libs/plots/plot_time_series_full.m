...
hold(ax1, 'on');
plot(ax1, time_vector, true_csm, 'k', 'LineWidth', 2.0);
...
legend(ax1, {'True Unwrapped Phase (LOS detrended) - Without Zoom', 'KF-AR LOS','AKF-AR LOS','AHL-KF-AR LOS'}, ...
    'Location', 'northwest');
...
hold(ax2, 'on');
plot(ax2, time_vector, true_tppsm, 'k', 'LineWidth', 2.0);
...
title(ax2, 'TPPSM - LOS Estimates (AR Only) - Without Zoom');
...
title(ax4, 'TPPSM - Scintillation Estimates (AR only) - Without Zoom');
...
hold(ax5, 'on');
plot(ax5, time_vector, true_csm, 'k', 'LineWidth', 2.0);
...
legend(ax5, {'True Unwrapped Phase (LOS detrended)', 'KF-AR joint','AKF-AR joint','AHL-KF-AR joint',...
...
hold(ax6, 'on');
plot(ax6, time_vector, true_tppsm, 'k', 'LineWidth', 2.0);
...
title(ax6, 'TPPSM - Joint Estimates - Without Zoom');
