function plot_time_series_zoom(...
    time_vector, ...
    los_phase, ...
    psi_csm, ...
...
hold(ax1, 'on');
plot(ax1, time_vector, wrapToPi(true_csm), 'k', 'LineWidth', 2.0);
plot(ax1, time_vector, wrapToPi(los_kf_ar), 'r', 'LineWidth', 1.0);
plot(ax1, time_vector, wrapToPi(los_akf_ar), 'b', 'LineWidth', 1.0);
plot(ax1, time_vector, wrapToPi(los_ahl_kf_ar), 'g', 'LineWidth', 1.0);
hold(ax1, 'off');
grid(ax1, 'on');
xlabel(ax1, 'Time [sec]');
ylabel(ax1, 'Phase [rad]');
title(ax1, 'CSM - LOS Estimates  (AR only) - Zoomed');
legend(ax1, {'True wrapped Phase (LOS detrended)', 'KF-AR LOS','AKF-AR LOS','AHL-KF-AR LOS'}, ...
    'Location', 'best');
...
hold(ax2, 'on');
plot(ax2, time_vector, wrapToPi(true_tppsm), 'k', 'LineWidth', 2.0);
plot(ax2, time_vector, wrapToPi(los_kf_ar_tppsm), 'r', 'LineWidth', 1.0);
plot(ax2, time_vector, wrapToPi(los_akf_ar_tppsm), 'b', 'LineWidth', 1.0);
plot(ax2, time_vector, wrapToPi(los_ahl_kf_ar_tppsm), 'g', 'LineWidth', 1.0);
hold(ax2, 'off');
grid(ax2, 'on');
xlabel(ax2, 'Time [sec]');
ylabel(ax2, 'Phase [rad]');
title(ax2, 'TPPSM - LOS Estimates (AR only) - Zoomed');
%legend(ax2, {'True Unwrapped Phase (LOS detrended)','KF-AR LOS','AKF-AR LOS','AHL-KF-AR LOS'}, ...
%    'Location', 'southwest');
if is_save_figures
    save_tab(tabLOS, 'comparison_los_zoomed');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
title(ax3, 'CSM - Scintillation Estimates (AR only) - Zoomed');
...
hold(ax5, 'on');
plot(ax5, time_vector, wrapToPi(true_csm), 'k', 'LineWidth', 2.0);
plot(ax5, time_vector, wrapToPi(joint_kf_ar_csm), 'r', 'LineWidth', 1.0);
plot(ax5, time_vector, wrapToPi(joint_akf_ar_csm), 'b', 'LineWidth', 1.0);
plot(ax5, time_vector, wrapToPi(joint_ahl_kf_ar_csm), 'g', 'LineWidth', 1.0);
plot(ax5, time_vector, wrapToPi(joint_kf_std_csm), '--r', 'LineWidth', 1.0);
plot(ax5, time_vector, wrapToPi(joint_akf_std_csm), '--b', 'LineWidth', 1.0);
plot(ax5, time_vector, wrapToPi(joint_ahl_kf_std_csm), '--g', 'LineWidth', 1.0);
hold(ax5, 'off');
grid(ax5, 'on');
xlabel(ax5, 'Time [sec]');
ylabel(ax5, 'Phase [rad]');
title(ax5, 'CSM - Joint Estimates - Zoomed');
legend(ax5, {'True Wrapped Phase (LOS detrended)', 'KF-AR joint','AKF-AR joint','AHL-KF-AR joint',...
...
hold(ax6, 'on');
plot(ax6, time_vector, wrapToPi(true_tppsm), 'k', 'LineWidth', 2.0);
plot(ax6, time_vector, wrapToPi(joint_kf_ar_tppsm), 'r', 'LineWidth', 1.0);
plot(ax6, time_vector, wrapToPi(joint_akf_ar_tppsm), 'b', 'LineWidth', 1.0);
plot(ax6, time_vector, wrapToPi(joint_ahl_kf_ar_tppsm), 'g', 'LineWidth', 1.0);
plot(ax6, time_vector, wrapToPi(joint_kf_std_tppsm), '--r', 'LineWidth', 1.0);
plot(ax6, time_vector, wrapToPi(joint_akf_std_tppsm), '--b', 'LineWidth', 1.0);
plot(ax6, time_vector, wrapToPi(joint_ahl_kf_std_tppsm), '--g', 'LineWidth', 1.0);
hold(ax6, 'off');
grid(ax6, 'on');
xlabel(ax6, 'Time [sec]');
ylabel(ax6, 'Phase [rad]');
title(ax6, 'TPPSM - Joint Estimates - Zoomed');
...
if is_save_figures
    save_tab(tabJoint, 'comparison_joint_zoomed');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
