% Project Title: KF_VAR_General_Config
...
function [Px_0_0,x_hat_0_0,Qk,Fk,C] = KF_VAR_General_Config(L,M,NumSeries,P,T_I,sigma2,fd,fdr,deltaArray,Q_arfit,A,c,TopologySelector)
...
ScintInit_States = zeros(NumSeries,P);
ScintInit_States = ScintInit_States(:).';
ScintInit_Covariance = ones(NumSeries,P)*(pi^2/3);
