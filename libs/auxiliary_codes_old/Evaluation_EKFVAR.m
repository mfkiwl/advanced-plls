...
function [RMSED,RMSEI,RMSET,RMSERho,errorD,errorI,errorT,errorRho] = Evaluation_EKFVAR(xkk1,phi_D_true,phi_I_true,rho_I_true,TopologySelector,L,M)
    if TopologySelector == 1
        phiL1_D_error = xkk1(:,1) - phi_D_true(:,1);
        phiL1_T_error = xkk1(:,1) + xkk1(:,2*L+M) - phi_D_true(:,1) - phi_I_true(:,1);
    ...
    elseif TopologySelector == 2
        ...
        phiL5_T_error = xkk1(:,2) + xkk1(:,2*L+M+1) - phi_D_true(:,2) - phi_I_true(:,2);
    ...
    elseif TopologySelector == 3
        ...
        phiL2_T_error = xkk1(:,2) + xkk1(:,2*L+M+1) - phi_D_true(:,2) - phi_I_true(:,2);
        ...
        phiL5_T_error = xkk1(:,3) + xkk1(:,2*L+M+2) - phi_D_true(:,3) - phi_I_true(:,3);
        phiL5_I_error = phiL5_T_error - phiL5_D_error;
