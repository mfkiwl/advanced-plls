...
[rx_sig_csm, los_phase, diffractive_phase_settled, refractive_phase_settled] = get_received_signal(L1_C_over_N0_dBHz, 'CSM', doppler_profile, ...
    'S4', S4, 'tau0', tau0, 'simulation_time', simulation_time, 'settling_time', settling_time);
[rx_sig_tppsm, ~, psi_tppsm, ps_realization] = get_received_signal(L1_C_over_N0_dBHz, 'TPPSM', doppler_profile, ...
    'tppsm_scenario', 'Severe', 'simulation_time', simulation_time, 'settling_time', settling_time, 'is_refractive_effects_removed', is_refractive_effects_removed);
...
training_data_config_tppsm = struct('scintillation_model', 'TPPSM', 'scenario', 'Severe', ...
                                    'simulation_time', training_simulation_time, 'is_refractive_effects_removed', true, 'sampling_interval', sampling_interval, 'is_unwrapping_used', false);
