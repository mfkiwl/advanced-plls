...
settling_time = 50;
cpssm_scenario = 'weak';
is_refractive_effects_removed_received_signal = true; % Change this to true to assess the behavior with refractive effects, and to false to assess only with diffractive effects.
