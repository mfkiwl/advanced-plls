% error_series_plots_vs_sigma2_W.m
%
...
% save outputs
out_base = fullfile(results_dir, sprintf('%s_phase_errors_zoom','cpssm_wo_refr'));
exportgraphics(fig, [out_base,'.pdf'], 'ContentType','vector');
savefig(fig, [out_base,'.fig']);
...
% save outputs
out_base = fullfile(results_dir, sprintf('%s_phase_errors_zoom','cpssm_w_refr'));
exportgraphics(fig, [out_base,'.pdf'], 'ContentType','vector');
savefig(fig, [out_base,'.fig']);
